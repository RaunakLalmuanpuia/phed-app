<template>
    <q-page class="container" padding>
        <div class="flex items-center justify-between q-pa-md bg-white">
            <div>
                <div class="stitle">Create Employee - Work Charge</div>
        ...
        <q-form @submit.prevent="submit" class="bg-white q-pa-md">
            <q-stepper v-model="step" ref="stepper" animated color="secondary">
                ...
                >
                    ...
                    <div class="row q-col-gutter-sm q-mb-md">
                        <div class="col-12 col-sm-6"> <strong>Employment Type:</strong> Work Charge Employee </div>
                        ...
                        <div class="col-12 col-sm-6"> <strong>Date of Retirement:</strong> {{ formatDate(form.date_of_retirement) }} </div>
...
const nextStep = () => {
    if (step.value === '1') {
        ...
        if (
            !form.employment_type || !form.designation || !form.office
        ) {

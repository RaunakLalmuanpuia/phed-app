<template>
    <q-page class="container" padding>
        ...
        <div class="flex items-center justify-between q-pa-md bg-white">
            <div>
                <div class="stitle">Muster Roll Employee List: <q-chip square v-for="office in offices" :key="office.value" :label="office.label"/></div>
...
function onRequest (prop) {
    ...
    loading.value = true
    axios.get(route('employees.json-manager-mr'),{
        params:{
            filter,
            page,
            rowsPerPage,

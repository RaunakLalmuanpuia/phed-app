<template>
    <q-page class="container" padding>
        <div class="flex items-center justify-between q-pa-md bg-white">
            <div>
                <div class="stitle">Create Document Type</div>
                <q-breadcrumbs class="text-dark">
                    ...
                    <q-breadcrumbs-el label="New Document Type"/>
                </q-breadcrumbs>
            </div>
        </div>
        <br/>
        <q-form @submit="submit" class="bg-white q-pa-md">
            <div style="max-width: 720px" class="row q-col-gutter-sm">
                ...
                <div class="col-xs-12 flex q-gutter-sm">
                    ...
                    <q-btn class="sized-btn" color="negative" outline label="Cancel" @click="$inertia.get(route('document-type.index'))"/>
                </div>

...
<div class="page">
    ...
    <p class="center bold" style="text-decoration: underline;">ENGAGEMENT CARD FOR PROVISIONAL EMPLOYEE</p>
    <div class="spacer-md"></div>

    <p class="right-align bold">Engagement Card No: <span style="text-decoration: underline;">{{ $card_no }}</span></p>
    <p class="right-align bold">Date: <span style="text-decoration: underline;">{{ $date }}</span></p>
    <div class="spacer-md"></div>

    <p>
        <strong>
            <span style="text-decoration: underline;">{{ $name }}</span>, (Date of Birth) <span style="text-decoration: underline;">{{ $dob }}</span> s/o
    ...
    <p class="bold">&emsp;&emsp;(a)&emsp;DP&amp;AR&nbsp;:&nbsp;{{ $approval_dpar }}</p>
    <p class="bold">&emsp;&emsp;(b)&emsp;Finance Department&nbsp;:&nbsp;{{ $approval_fin }}</p>
    <div class="spacer-sm"></div>

    <p>6.&emsp;Debitable head of account&nbsp;:&nbsp;{{ $account_head_1 }}</p>
    <div style="padding-left: 14em; margin-top: 2px;">
        <p>{{ $account_head_2 }}</p>
        <p>{{ $account_head_3 }}</p>
        <p>{{ $account_head_4 }}</p>
        <p>{{ $account_head_5 }}</p>
    ...
    <div class="signature-block">
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/msegs.png'))) }}" alt="Signature" />
